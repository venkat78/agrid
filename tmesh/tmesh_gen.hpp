...
namespace tmesh {
  ...
  VOID MeshFromFacets(std::list<iFACET> &facetLabels, _Mesh_Type_A &oldMesh,
		      _Mesh_Type_B &newMesh)
  {
   ...
   */
  template <typename _Mesh_Type_A, typename _Mesh_Type_B >
  VOID MeshFromManifolds(std::vector<iMANIFOLD> &manifoldLabels, _Mesh_Type_A &oldMesh,
		      _Mesh_Type_B &newMesh)
  {
