...
namespace tmesh {
  ...
  class tCONSTRUCT_MANIFOLDS {
      ...
      eORIENTATION Construct(cFACET *facet, std::vector<BOOL> &facetsToBeFlipped, sTRUE a);

      eORIENTATION Construct(cFACET *facet, std::vector<BOOL> &facetsToBeFlipped, sFALSE a);
      INT RetVal();
