  ...
  do {
    ...
    while (i < oldFrontSize) {
      ...
      AddToFront(cellColor,
                 iCELL_INDEX(cellIndex.x - 1, cellIndex.y, cellIndex.z), front,
                 alreadyVisited);
      ...
      AddToFront(cellColor,
                 iCELL_INDEX(cellIndex.x, cellIndex.y - 1, cellIndex.z), front,
                 alreadyVisited);
      ...
      AddToFront(cellColor,
                 iCELL_INDEX(cellIndex.x, cellIndex.y, cellIndex.z - 1), front,
                 alreadyVisited);
