...
%.o: ../%.cpp
	...
	g++ -I"/home/Bujji/git/agrid/surface_mesh" -I"/home/Bujji/git/agrid/spatial_trees" -I"/home/Bujji/git/agrid/agrid-mesh" -I"/home/Bujji/git/agrid/mesh_utils" -I"/home/Bujji/git/agrid/tmesh" -I"/home/Bujji/git/agrid/geom" -I"/home/Bujji/git/agrid/io" -I"/home/Bujji/git/agrid/utils" -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
