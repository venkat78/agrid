...
//          m_srcMesh(NULL)
    ...
    tCUT_CELL_VERTEX(const cPOINT3 &point)
        : cBASE(point)
//    ,
//          m_srcMesh(NULL)
    {
...
template<typename _Mesh_Entities, typename _Storage_Policy, template<typename _ME, typename _SP> class _Object_Factory>
class tCUT_CELL : public tMESH<_Mesh_Entities, _Storage_Policy, _Object_Factory> {
   public:
...
TYPEDEF_SUBMESH(cCUT_CELL, tCUT_CELL, sCUT_CELL_STORAGE_POLICY, tMESH_OBJECT_FACTORY, tCUT_CELL_VERTEX, tHALF_EDGE, tCUT_CELL_FACET);
